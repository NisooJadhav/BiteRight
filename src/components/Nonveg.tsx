...
function Nonveg() {
  ...
  const fetchRecipes = async () => {
    try {
      const categories = ["Seafood", "Chicken", "Goat", "Lamb"];
      ...
      console.error("Error fetching non-veg recipes:", error);
    }
  };
  ...
  return (
    <>
      ...
      {visibleCount < recipes.length && recipes.length > 0 && ( // Update the condition to check if there are recipes to show
